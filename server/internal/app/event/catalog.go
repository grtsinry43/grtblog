...
var catalog = []EventDescriptor{
	{Name: "article.created", Title: "文章创建", Category: "content", Description: "创建文章后触发", PublicEmail: true, Channels: []string{ChannelEmail, ChannelWebhook}, Fields: []EventField{{Name: "ID", Type: "int64", Required: true, Description: "文章ID"}, {Name: "Title", Type: "string", Required: true, Description: "标题"}, {Name: "ShortURL", Type: "string", Required: true, Description: "短链"}, {Name: "Published", Type: "bool", Required: true, Description: "是否发布"}}},
	{Name: "article.updated", Title: "文章更新", Category: "content", Description: "更新文章后触发", Channels: []string{ChannelEmail, ChannelWebhook}, Fields: []EventField{{Name: "ID", Type: "int64", Required: true, Description: "文章ID"}, {Name: "Title", Type: "string", Required: true, Description: "标题"}, {Name: "ShortURL", Type: "string", Required: true, Description: "短链"}, {Name: "Published", Type: "bool", Required: true, Description: "是否发布"}}},
	{Name: "article.published", Title: "文章发布", Category: "content", Description: "文章发布后触发", Channels: []string{ChannelEmail, ChannelWebhook}, Fields: []EventField{{Name: "ID", Type: "int64", Required: true, Description: "文章ID"}, {Name: "Title", Type: "string", Required: true, Description: "标题"}, {Name: "ShortURL", Type: "string", Required: true, Description: "短链"}}},
	...
	{Name: "moment.published", Title: "手记发布", Category: "content", Description: "手记发布后触发", Channels: []string{ChannelEmail, ChannelWebhook}, Fields: []EventField{{Name: "ID", Type: "int64", Required: true, Description: "手记ID"}, {Name: "Title", Type: "string", Required: true, Description: "标题"}, {Name: "ShortURL", Type: "string", Required: true, Description: "短链"}}},
	...
	{Name: "page.created", Title: "页面创建", Category: "content", Description: "创建页面后触发", PublicEmail: true, Channels: []string{ChannelEmail, ChannelWebhook}, Fields: []EventField{{Name: "ID", Type: "int64", Required: true, Description: "页面ID"}, {Name: "Title", Type: "string", Required: true, Description: "标题"}, {Name: "ShortURL", Type: "string", Required: true, Description: "短链"}}},
	...
	{Name: "websiteinfo.updated", Title: "站点信息更新", Category: "system", Description: "站点信息更新后触发", Channels: []string{ChannelEmail, ChannelWebhook}, Fields: []EventField{{Name: "Key", Type: "string", Required: true, Description: "配置键"}, {Name: "Name", Type: "string", Required: false, Description: "展示名"}, {Name: "Value", Type: "string", Required: false, Description: "值"}}},
	...
	{Name: "friendlink.application.approved", Title: "友链申请通过", Category: "friendlink", Description: "友链申请通过后触发", Channels: []string{ChannelEmail, ChannelWebhook}, Fields: []EventField{{Name: "ID", Type: "int64", Required: true, Description: "申请ID"}, {Name: "URL", Type: "string", Required: true, Description: "站点URL"}}},
	{Name: "friendlink.application.rejected", Title: "友链申请拒绝", Category: "friendlink", Description: "友链申请拒绝后触发", Channels: []string{ChannelEmail, ChannelWebhook}, Fields: []EventField{{Name: "ID", Type: "int64", Required: true, Description: "申请ID"}, {Name: "URL", Type: "string", Required: true, Description: "站点URL"}}},
