...
export const GET: RequestHandler = async ({ url, fetch, request }) => {
	...
	const subtitle = clipText(
		normalizeText(url.searchParams.get('subtitle') || 'A personal blog about software and life.'),
		MAX_SUBTITLE_LENGTH
	);
	const site = clipText(normalizeText(url.searchParams.get('site') || 'grtBlog'), MAX_SITE_LENGTH);
