<script lang="ts">
	...
	const variantClasses = {
		jade: 'border border-jade-500/10 bg-jade-500/10 text-jade-700 dark:text-jade-400',
		ink: 'border border-ink-100 bg-ink-500/5 text-ink-500 dark:border-ink-800/50 dark:text-ink-400',
		amber: 'border border-amber-500/20 bg-amber-500/10 text-amber-700 dark:text-amber-400',
		cinnabar:
			'text-cinnabar-700 dark:text-cinnabar-400 border border-cinnabar-500/20 bg-cinnabar-500/10',
