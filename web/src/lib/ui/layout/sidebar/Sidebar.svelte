...
>
	...
	<div class="flex flex-none flex-col items-center gap-6 pb-6 pt-6">
		<button
			class="flex h-10 w-10 items-center justify-center rounded-default text-ink-400 transition-colors hover:bg-ink-100 hover:text-ink-900 dark:hover:bg-ink-800 dark:hover:text-ink-100"
		>
			<SearchIcon />
		</button>
		<ThemeIcon />
