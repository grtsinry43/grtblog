<script lang="ts">
	...
	const isMe = (role: string) => 
		['me', 'user', 'admin', '我', '本人'].includes(role.toLowerCase());
</script>

<div class="chat-wrapper not-prose my-8 overflow-hidden rounded-default border border-ink-200/60 bg-white dark:border-ink-800/60 dark:bg-ink-950/20">
	<!-- 简洁的 Header -->
	<div class="flex items-center justify-between border-b border-ink-100/60 bg-ink-50/30 px-5 py-2.5 dark:border-ink-800/60 dark:bg-ink-900/40">
	...
	<div class="flex flex-col gap-4 p-5">
		...
		{:else}
			<div class="py-4 text-center text-xs italic text-ink-400">
